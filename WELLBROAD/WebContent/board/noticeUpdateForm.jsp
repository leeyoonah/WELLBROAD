	...
	<div class="main">
		...
		<div class="sub" id="sub">
			...
			<div class="sub-main">
				<center>
					<b>글수정</b><br>                         
						<form method="post" name="writeform" action="noticeUpdatePro.do?num=${article.num}&pageNum=${pageNum}">
							<table width="400" border="1" cellspacing="0" cellpadding="0" align="center">
								<tr>
									<td width="70"  align="center">이 름</td>
									<td align="left" width="330">
										<input type="text" size="10" maxlength="10" name="admin_id" value="${article.admin_id}"> 
								...
								<tr>
									<td colspan=2 align="center">
										...
										<input type="button" value="목록보기" onclick="document.location.href= 'noticeList.do?pageNum=${pageNum}'">
									</td>
								</tr>
							</table>
						</form>
