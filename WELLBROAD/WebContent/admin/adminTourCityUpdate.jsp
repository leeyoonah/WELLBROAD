								...
								<div class="form-three widget-shadow">
									<form name="tourCityInsertForm" class="form-horizontal" action="adminTourCityInsertPro.do" method="post">
											...
											<div class="col-sm-5">
												<select name="code_nation" id="code_nation" class="form-control1">
													...
													<c:forEach var="nation" items="${nationList}">
														<c:if test="${city.code_nation== nation.code_nation}">
										...
										<div class="form-group">
											...
											<div class="col-sm-5">
												<input type="text" class="form-control1" name="code_city" id="code_city" placeholder="Default Input" value="${city.code_city }">
											</div>
											<div class="col-sm-2">
										...
										<div class="form-group">
											...
											<div class="col-sm-5">
												<input type="text" class="form-control1" name="name" id="name" placeholder="Default Input" value="">
											</div>
											<div class="col-sm-3">
										...
										<div class="form-group">
											...
											<div class="col-sm-8"><textarea name="description" id="description" cols="50" rows="4" class="form-control1">${city.description }</textarea></div>
										</div>
