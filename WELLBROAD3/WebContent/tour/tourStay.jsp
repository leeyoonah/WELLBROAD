	...
	<div class="main">
		...
		<div id="header">
			...
			<section class="section-background">
				<div class="container">
					<h2 class="page-header">Tour Stay Information</h2><!-- 여행정보-도시 클릭시 보이는 타이틀 -->
		...
		<div class="sub" id="sub">
			<div class="sub-menu"><!-- 왼쪽 메뉴 -->
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="tourStay.do">stay</a></li>
			...
			<div class="sub-main"><!-- 오른쪽 내용(왼쪽에서 클릭한 메뉴에 따라 보여지는 내용이 다름) -->
					...
					<div class="row"><!-- grid를 사용하기 위함 -->
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
							<form class="form-inline"><!-- label과 select를 묶기 위한 form태그 -->
								...
								<select class="form-control" id="nation" onchange="location.href='tourStay.do?code_nation='+this.value">
						...
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
							<form class="form-inline"><!-- label과 select를 묶기 위한 form태그 -->
								...
								<select class="form-control" id="city" onchange="location.href='tourStay.do?code_nation=${code_nation }&code_city='+this.value">
									<option value="null">선택</option>
						...
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
							<form class="form-inline"><!-- label과 select를 묶기 위한 form태그 -->
									<label for="spot">숙박 </label>
								<select class="form-control" id="spot" onchange="location.href='tourStay.do?code_nation=${code_nation }&code_city=${code_city }&code='+this.value">
									<option value="null">선택</option>
				...
				<div class="sub-container"><!-- 관광을 선택하면 추가되는 것 정보(이름,이미지,주소,설명) -->
					<c:if test="${tour.name!=null}">
						<h2 class="tour_title"><img src="bar.png" width="7"/>&nbsp; ${tour.name }</h2>
