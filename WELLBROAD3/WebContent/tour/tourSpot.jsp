	...
	<div class="main">
		...
		<div id="header">
			...
			<section class="section-background">
				<div class="container">
					<h2 class="page-header">Tour Spot Information</h2><!-- 여행정보-도시 클릭시 보이는 타이틀 -->
		...
		<div class="sub" id="sub">
			<div class="sub-menu"><!-- 왼쪽 메뉴 -->
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="tourSpot.do">spot</a></li>
					...
					<div class="row"><!-- grid를 사용하기 위함 -->
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
							<form class="form-inline"><!-- label과 select를 묶기 위한 form태그 -->
								...
								<select class="form-control" id="nation" onchange="location.href='tourSpot.do?code_nation='+this.value">
						...
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
							<form class="form-inline"><!-- label과 select를 묶기 위한 form태그 -->
								...
								<select class="form-control" id="city" onchange="location.href='tourSpot.do?code_nation=${code_nation }&code_city='+this.value">
									<option value="null">선택</option>
						...
						<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
							<form class="form-inline"><!-- label과 select를 묶기 위한 form태그 -->
									<label for="spot">관광 </label>
								<select class="form-control" id="spot" onchange="location.href='tourSpot.do?code_nation=${code_nation }&code_city=${code_city }&code='+this.value">
									<option value="null">선택</option>
