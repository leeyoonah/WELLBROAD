									...
									<form name="tourCityInsertForm" class="form-horizontal" action="adminTourCityInsertPro.do" method="post">
										<div class="form-group">
											...
											<div class="col-sm-5">
												...
												<input type="text" class="form-control1" name="code_nation" id="code_nation" placeholder="Default Input" value="${city.code_nation }" readonly>
											</div>
											<div class="col-sm-3">
										...
										<div class="form-group">
											...
											<div class="col-sm-5">
												<input type="text" class="form-control1" name="code_city" id="code_city" placeholder="Default Input" value="${city.code_city }" readonly>
											</div>
											<div class="col-sm-2">
										...
										<div class="form-group">
											...
											<div class="col-sm-5">
												<input type="text" class="form-control1" name="name" id="name" placeholder="Default Input" value="${city.name }" readonly>
											</div>
											<div class="col-sm-3">
										...
										<div class="form-group">
											...
											<div class="col-sm-8"><textarea name="description" id="description" cols="50" rows="8" class="form-control1" style="height:auto" readonly>${city.description }</textarea></div>
										</div>
