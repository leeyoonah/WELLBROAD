	...
	<div class="main">
		...
		<div class="sub" id="sub">
			...
			<div class="sub-main">
				<center>
					<b>글삭제</b> <br>
					<form method="POST" name="delForm" action="noticeDeletePro.do?pageNum=${pageNum}&num=${num}">
					<!-- onsubmit="return deleteSave()" -->
						<table border="1" align="center" cellspacing="0" cellpadding="0" width="360">
							<tr height="30">
								<td align=center><b>아이디를 입력해주세요.</b></td>
							</tr>	
							<tr height="30">
								<td align=center>아이디 : <input type="text" name="admin_id" size="8" maxlength="12"> 
								</td>
							</tr>
							<tr height="30">
								<td align=center>
								<input type="submit" value="글삭제"> 
								<input type="button" value="글목록" onclick="document.location.href='noticeList.do?pageNum=${pageNum}'">
								</td>
							</tr>
						</table>
					</form>
